...
class GameOfLife {
	...
	private RuleSet ruleSet = new RuleSet(DEFAULT_BIRTH_COUNTS, DEFAULT_SURVIVAL_COUNTS);
	 ...
	 * @param colCount number of columns, i.e. the x dimension
	 * @param rowCount number of rows, i.e. the y dimension
	 */
	...
	/**
	 * A helper to wrap the coordinates around. Given a number and a maximum, wraps 
	 * the number in the range [0..maximum] inclusive.
	 * @param number
	 * @param max
	 * @return
	 */
